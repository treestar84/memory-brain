...
Use `bun test` to run tests. Use HTML imports with `Bun.serve()` for frontend (React/CSS/Tailwind supported); don't use `vite`.

For API usage details and examples, read `node_modules/bun-types/docs/**.md`.
